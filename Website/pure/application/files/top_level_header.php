		...
		<!-- top level branding section -->
			...
			<nav id="top_level_header_navigation_nav" class="dark">
				<ul id="top_level_header_navigation_list" class="clear">
					...
					<li id="top_level_header_navigation_list_item_portofolio"  class="portofolio_nav"><a id="top_level_header_nav_portofolio" href="portofolio.php?lang=<?php echo $language; ?>"><?php if ( $language == "el") { echo "Χαρτοφυλάκιο"; } else { echo "Portfolio"; } ?></a></li>
