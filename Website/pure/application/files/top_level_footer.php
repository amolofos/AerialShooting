	...
	<div id="top_level_footer_section_wrapper">
		<footer id="top_level_footer_section">
			...
			<section id="top_level_footer_law_section">
					<p><a href="application.php#termsofuse_section_wrapper">Όροι χρήσης</a> | <a href="application.php#sensitivedata_section_wrapper">Προσωπικά δεδομένα</a></p>
			</section>
			
			<!-- top level footer contact us section -->
			<section id="top_level_footer_contact_section">
				<p><a href="application.php#contact_section_wrapper">Επικοινωνήστε μαζί μας</a></p>
			</section>
