						...
						<article id="contact_article_production" class="article">
							...
							<div id="contact_article_production_content" class="content">
								<div id="contact_article_production_summary" class="summary">
									...
									<p>Director : Komakis George </br>Specialty : Director</p>
								</div>
							</div>
						</article>
					</li>
						...
						<article id="contact_article_technical" class="article">
							...
							<div id="contact_article_technical_content" class="content">
								<div id="contact_article_technical_summary" class="summary">
									...
									<p>Director : Imanimidis Konstantinos </br>Specialty : Pilot</p>
									<p>Director : Fantaoutsakis Georgios </br>Specialty : Engineer</p>
								</div>
							</div>
						</article>
					</li>
							...
							<div id="contact_article_social_content" class="content">
								<div id="contact_article_social_summary" class="summary">
									<div id="social_groups">
										<div id="facebook_contact"><a href="http://www.facebook.com/unmanned.evolution/" target="_blank" style="cursor: pointer;" class="social" title="Follow us in Facebook"><img src="../img/social/facebook.png" alt="Facebook"/></a></div>
										<div id="twitter_contact"><a href="https://twitter.com/Unmanned_gr" target="_blank" style="cursor: pointer;" class="social" title="Follow us in Twitter"><img src="../img/social/twitter.png" alt="Twitter"/></a></div>
										<div id="linkedin_contact"><a href="http://www.linkedin.com/company/2775181?trk=NUS_DIG_CMPY-fol" target="_blank" style="cursor: pointer;" class="social" title="Follow us in LinkedIn"><img src="../img/social/linkedin.png" alt="LinkedIn"/></a></div>
									</div>
									<div id="image_groups">
										<div id="youtube_contact"><a href="http://www.youtube.com/user/unmannedevolution/videos?view=0" target="_blank" style="cursor: pointer;" class="social" title="Watch us in Youtube"><img src="../img/social/youtube.png" alt="Youtube"/></a></div>
										<div id="vimeo_contact"><a href="https://vimeo.com/unmannedevolution" target="_blank" style="cursor: pointer;" class="social" title="Watch us in Vimeo"><img src="../img/social/vimeo.png" alt="Vimeo"/></a></div>
										<div id="flickr_contact"><a href="http://www.flickr.com/photos/unmanned-evolution/" target="_blank" style="cursor: pointer;" class="social" title="Watch us in Flickr"><img src="../img/social/flickr.png" alt="Flickr"/></a></div>
									</div>
									<div id="bookmarking_groups">
										...
										<div id="tumblr_contact"><a href="http://unmanned-evolution.tumblr.com/" target="_blank" style="cursor: pointer;" class="social" title="Watch us in Tumblr"><img src="../img/social/tumblr.png" alt="Tumblr"/></a></div>
							...
							<form id="SendMessageForm" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
								<fieldset>
									...
									<div id="name_container" class="container">
										...
										<input id="name" name="name" type="text" class="text" value="" required="required" placeholder="Your name is essential!"/>
										<span id="contactus_name_errorloc" class="error"></span>
									</div>
									<div id="email_container" class="container">
										<label for="email" lang="en">Email<span class="required"> *</span></label><br>
										<input id="email" name="email" type="email" class="text" value="" required="required" placeholder="Your email is essential!"/>
									...
									<div id="project_type_container" class="container">
										<label for="project_type">Project category</label><br>
										<input id="project_type" name="project_type" type="text" class="text" value=""/>
									</div>
									<div id="message_container" class="container">
										<label for="message" id="message_label">Message body<span class="required"> *</span></label><br>		
										<textarea id="message" name="message" required="required" placeholder="Write us about the project to be implemented."></textarea>
										<span id="contactus_message_errorloc" class="error"></span>
									</div>
									<div id="attachements_container" class="container">
										<label for="attachments" id="attachments_label">Attachements.</label><br>
