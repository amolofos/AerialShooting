...
ES 201 674 \\ 
			...
			\paragraph{1200 MHz}{Αναφορικά με τη συχνότητα των 1200 MHz (1,2 GHz), είναι δεσμευμένη για εφαρμογές ραδιοερασιτεχνίας. Συνεπώς, διέπεται από συγκεκριμένο νομοθετικό πλαίσιο το οποίο είναι αρκετά δεσμευτικό. Για τη χρήση του φάσματος αυτού υποχρεούται να αποκτηθεί δίπλωμα ραδιοερασιτέχνη, να γίνει  εγγραφή στο μητρώο των και να αποκτηθεί άδεια εκπομπής η οποία περιορίζεται σε συγκεκριμένη γεωγραφική περιοχή.
			}
